...
function ciniki_toolbox_uploadXLSDelete($ciniki) {
	...
	if( isset($_FILES['uploadfile']['error']) && $_FILES['uploadfile']['error'] == UPLOAD_ERR_INI_SIZE ) {
		return array('stat'=>'fail', 'err'=>array('code'=>'92', 'msg'=>'Upload failed, file too large.'));
	}

	if( !isset($_FILES) || !isset($_FILES['uploadfile']) || $_FILES['uploadfile']['name'] == '' ) {
		return array('stat'=>'fail', 'err'=>array('code'=>'91', 'msg'=>'Upload failed, no file specified.', '_FILES'=>$_FILES));
	}
	...
	try {
		...
		ciniki_core_dbTransactionRollback($ciniki, 'toolbox');
		return array('stat'=>'fail', 'err'=>array('code'=>'94', 'msg'=>'Unable to understand spreadsheet data'));
	}
